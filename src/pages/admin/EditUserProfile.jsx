...
const profileForm = () => {
    ...
    const onSubmit = (data) => {
        ...
        const { gender, firstname, lastname, email, phoneNumber, id } = data;
        const registerData = {
            "gender": gender,
            "firstName": firstname,
            "lastName": lastname,
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            {...register('firstname')}
                            className=" bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-50 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
